...
public abstract class TemplateMatcherNode : TemplateNode
{
    ...
    private sealed class EmptyNode : TemplateMatcherNode
    {
        ...
        public override TResult Visit<TResult>(TemplateMatcherVisitor<TResult> visitor) => throw new InvalidOperationException("No Empty Template node Should Encounterd");
    }
}