...
public abstract class ContentManager
{
    ...
    {
        public override DateTime GetDateTime(string name, string? fileName = null)
        ...
        public override Func<string> GetStringFunc(string name, string? fileName = null)
            => throw new NotImplementedException();
...
public sealed class FileContentManager : ContentManager
{
    ...
    public override DateTime GetDateTime(string name, [CallerFilePath] string? fileName = null) => GetToken(
        name,
        fileName).Value<DateTime>();

    public override int GetInt(string name, [CallerFilePath] string? fileName = null) => GetToken(
        name,
        fileName).Value<int>();
    ...
    public override string GetString(string name, [CallerFilePath] string? fileName = null)
    {
        var value = GetToken(
            name,
            fileName).Value<string>() ?? string.Empty;
