...
public sealed record InternalGamePackage(string OriginalPath, GamePackage GamePackage, PackageScriptManager ScriptManager, PackageContentManager ContentManager);
