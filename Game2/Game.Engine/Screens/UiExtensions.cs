...
public static class UiExtensions
{
    public static Button OnClick(this Button btn, View container, Func<IObservable<Unit>, IDisposable> handler)
    {
        ...
        return btn.OnConnect(
            container,
            () => handler(btnEvents.Clicked));
    }
    ...
    public static MenuBar CreateMenuBar(this View container,
        Func<MenuItemFactory, IEnumerable<MenuBarItemBuilder>> factory)
    {
    ...
    public sealed class MenuItemFactory
    {
        ...
        public MenuBarItemBuilder NewMenuBarItem() => new(
            this,
            _container);

        public MenuItemBuilder NewMenuItem() => new(
            this,
            _container);
    }
        ...
        where TItemType : MenuItem
    {
        ...
        protected MenuItemBuilderBase(MenuItemFactory itemFactory, View container,
            Func<Action, string, TItemType> itemBuilder)
        {
    ...
    public sealed class MenuBarItemBuilder : MenuItemBuilderBase<MenuBarItemBuilder, MenuBarItem>
    {
        ...
        public override MenuBarItem Build(MenuBar bar)
        {
            ...
            if (ChildMenu is not null) item.Children = ChildMenu().Select(mb => mb.Build(bar)).ToArray();
