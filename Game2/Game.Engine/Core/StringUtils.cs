...
{
    public static KeyValuePair<TKey, TValue> ToPair<TKey, TValue>((TKey, TValue) pair) => KeyValuePair.Create(pair.Item1, pair.Item2);
    ...
    public static (string Left, string Right) SplitAroundFirstCharFromLeft(this string s, char c) =>
        s.SplitAroundCharFromLeft(PredicateUtils.ObjectEquals(c));

    public static (string Left, string Right) SplitAroundFirstCharFromRight(this string s, char c) =>
        s.SplitAroundCharFromRight(PredicateUtils.ObjectEquals(c));

    public static (string Left, string Right) SplitAroundCharFromLeft(this string s, char c) =>
        s.SplitAroundCharFromLeft(PredicateUtils.ObjectEquals(c));

    public static (string Left, string Right) SplitAroundCharFromLeft(this string s, Predicate<char> isSplitChar) =>
        s.SplitAroundCharFromLeft(0, isSplitChar);
    ...
    public static (string Left, string Right) SplitAroundCharFromRight(this string s, char c) =>
        s.SplitAroundCharFromRight(PredicateUtils.ObjectEquals(c));
