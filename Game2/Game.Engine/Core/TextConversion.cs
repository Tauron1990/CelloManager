	...
	public static class TextConversion
	{
		...
		public static byte[] FromHexString(string s)
		{
			...
			for (var i = 0; i < s.Length; i += 2)
			{
				...
				{
					throw new ArgumentException("Contains invlaid hexadecimal values", nameof(s));
				}
		...
		public static int ToBase64CharArray(byte[] input, int offsetIn, int length, char[] outArray, int offsetOut) => Convert.ToBase64CharArray(input, offsetIn, length, outArray, offsetOut);
