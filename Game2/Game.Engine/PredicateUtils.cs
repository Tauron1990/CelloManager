...
public static class PredicateUtils
{
	...
	/// <returns>A new predicate</returns>
	public static Predicate<T> And<T>(this Predicate<T> predicate1, Predicate<T> predicate2) => value => predicate1(value) && predicate2(value);
	...
	public static Predicate<T> And<T>(this Predicate<T> predicate1, params Predicate<T>[] predicates) =>
		value => predicate1(value) && predicates.All(predicate => predicate(value));
	...
	/// <param name="predicate2">The second predicate</param>
	/// <returns>A new predicate</returns>
	public static Predicate<T> Or<T>(this Predicate<T> predicate1, Predicate<T> predicate2) => value => predicate1(value) || predicate2(value);
	...
	public static Predicate<T> Or<T>(this Predicate<T> predicate1, params Predicate<T>[] predicates) =>
		value => predicate1(value) || predicates.Any(predicate => predicate(value));
	...
	/// </returns>
	public static Predicate<T> ObjectNotEquals<T>(T value) => value2 => value != null && !value.Equals(value2);
	...
	/// </returns>
	public static Predicate<T> ObjectEquals<T>(T value) => value2 => value != null && value.Equals(value2);
	...
	/// The new <c>Predicate</c>.
	/// </returns>
	public static Predicate<T> ObjectEqualsAny<T>(params T[] values) => value2 => Array.IndexOf(values, value2) >= 0;
