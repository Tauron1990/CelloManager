...
namespace Tauron.Application.CelloManager.Logic.RefillPrinter.Rule
{
    ...
    public static class PrintHelper
    {
        ...
        public static bool PrintOrder(CommittedRefill refill, string name)
        {
            bool temp = false;
            ...
            UiSynchronize.Synchronize.Invoke(() =>
                                             {
                                                 ...
                                                 {
                                                     LocalPrintServer server = new LocalPrintServer(PrintSystemDesiredAccess.UsePrinter);
